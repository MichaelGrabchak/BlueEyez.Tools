-- The Stored Procedure that generates SQL Merge query based on table
-- Author: https://github.com/readyroll/generate-sql-merge

CREATE PROC [utility].[sp_generate_merge]
(
